...
window.toggleMealEntry = toggleMealEntry;
window.confirmMealTime = confirmMealTime;
window.closeMealTimePicker = closeMealTimePicker;
window.createMealDonut = createMealDonut;
