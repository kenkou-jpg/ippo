...
import './modules/persistence-limited-adoption.js';
...
if (typeof window.ippoMarkServiceReady === 'function') {
  window.ippoMarkServiceReady('main-entry', {
    ...
    hasPersistenceLimitedAdoption: typeof window.ippoPersistenceLimitedAdoptionSummary === 'function',
  });
}
...
if (typeof window.ippoRunPersistenceLimitedAdoptionCheck === 'function') {
  window.setTimeout(() => {
    try {
      window.ippoRunPersistenceLimitedAdoptionCheck('main-entry-post-module-load');
    } catch (error) {
      if (typeof window.ippoMarkBootError === 'function') {
        window.ippoMarkBootError('persistence-limited-adoption-check-failed', {
          message: error && error.message ? error.message : String(error),
        });
      }
    }
