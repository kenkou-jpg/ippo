...
// PR-089B時点のベースライン（Batch-11分割① — Experiment Module Migrationの物理移動後の実測値）。
// PR-088時点は5,084行、PR-087時点は5,408行、PR-086時点は5,611行、PR-085時点は6,242行、
// PR-084時点は6,650行、PR-083時点は7,025行、PR-082G(Batch-4 Exit Audit)時点は7,071行、
// PR-082E時点は7,664行、PR-082D時点は8,186行、PR-082C時点は8,441行、PR-082B時点は8,806行、
...
const BASELINE_LINE_COUNT = 4450;
