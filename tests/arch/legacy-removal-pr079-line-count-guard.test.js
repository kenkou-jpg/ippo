...
// PR-089C時点のベースライン（Batch-11分割② — Cloud Sync Migrationの物理移動後の実測値）。
// PR-089B時点は4,450行、PR-088時点は5,084行、PR-087時点は5,408行、PR-086時点は5,611行、
// PR-085時点は6,242行、PR-084時点は6,650行、PR-083時点は7,025行、
...
const BASELINE_LINE_COUNT = 4252;
