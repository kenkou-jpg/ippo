...
// PR-089F-5時点のベースライン（Batch-11分割⑥-5 — Meal Cluster移植後の実測値）。
// PR-089F-4時点は3,176行、PR-089F-3時点は3,283行、PR-089F-2時点は3,423行、PR-089F-1時点は3,507行、PR-089E時点は3,760行（調査のみ・変更なし）、PR-089D時点は3,760行、
...
const BASELINE_LINE_COUNT = 2918;
