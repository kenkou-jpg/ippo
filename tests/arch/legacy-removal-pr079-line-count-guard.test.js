...
// PR-089F-3時点のベースライン（Batch-11分割⑥-3 — Symptom UI Cluster移植後の実測値）。
// PR-089F-2時点は3,423行、PR-089F-1時点は3,507行、PR-089E時点は3,760行（調査のみ・変更なし）、PR-089D時点は3,760行、
...
const BASELINE_LINE_COUNT = 3283;
