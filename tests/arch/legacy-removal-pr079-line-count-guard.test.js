...
// PR-082F時点のベースライン（Batch-4 分割②〜⑥ — AI Analysis Overlay /
// Monthly Report / Cycle Phase Report / Temperature Report /
// Flareup Report・Correlation Report・calcWellnessScoreの物理移動後の実測値）。
...
const BASELINE_LINE_COUNT = 7071;
