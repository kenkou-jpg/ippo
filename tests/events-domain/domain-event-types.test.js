...
describe('DOMAIN_EVENT_TYPES', () => {
  ...
  it('has exactly 22 event types (PR-049 adds ENVIRONMENTAL_SIGNAL_RECORDED)', () => {
    expect(Object.keys(DOMAIN_EVENT_TYPES)).toHaveLength(22);
  });
...
describe('DOMAIN_EVENT_TYPE_SET', () => {
  ...
  it('has 22 entries (PR-049 adds ENVIRONMENTAL_SIGNAL_RECORDED)', () => expect(DOMAIN_EVENT_TYPE_SET.size).toBe(22));
